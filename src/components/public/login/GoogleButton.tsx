 ...
 const login = useGoogleLogin({
    ...
    onSuccess: async (codeResponse) => {
      try {
        ...
        if (!res.ok) {
          toast.error(data.errors.email || 'Google login failed')
          return
        }
  ...
  return (
    <>
      ...
      <button 
        ...
        className="w-full h-12 text-center border-dark-blue rounded-full border px-6 py-2 mt-4 
         hover:bg-gray-100 transition mb-6 flex items-center justify-center cursor-pointer">
