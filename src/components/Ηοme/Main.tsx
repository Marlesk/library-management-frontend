    ...
    <div className="flex flex-col-reverse md:flex-row h-auto md:h-screen px-6 md:px-8 py-12 md:py-0">
      <div className="w-full md:w-1/2 flex flex-col justify-center space-y-6 md:pr-8 text-center">
        ...
        <div className="flex justify-center space-x-4 ">
          <button className="bg-button-blue text-white px-6 py-2 rounded-lg hover:bg-dark-blue transition cursor-pointer active:bg-dark-blue">
            Sign Up
          </button>
          <button className="border border-button-blue text-dark-blue px-6 py-2 rounded-lg hover:bg-blue-50 transition cursor-pointer active:bg-blue-50 ">
            Log In
          </button>
        </div>
      </div>
